#!/usr/bin/env bash
# DoRA variant of run_dapo_lora_baseline.sh
# Changes vs LoRA: adds use_dora=True
set -xeuo pipefail

export HYDRA_FULL_ERROR=1

project_name='lora_rlvr'
exp_name="dapo-qwen3-8b-sft-dolci-dora-r32_$(date +%m%d_%H%M)"
...
# Paths
MODEL_PATH="/mnt/llm-train-5p/shenzhennan/models/Qwen3-8B-Base-sft-dolci-think/iter_0005375-hf"
TRAIN_FILE="/mnt/llm-train-5p/shenzhennan/datasets/dapo-math-17k-boxed/train.parquet"
...
python3 -m recipe.dapo.main_dapo \
    ...
    +actor_rollout_ref.model.use_dora=True \
