#!/usr/bin/env bash
# Full fine-tuning variant of run_dapo_lora_baseline.sh
# Changes vs LoRA: no lora_rank/lora_alpha/lora.merge, lower lr
set -xeuo pipefail

export HYDRA_FULL_ERROR=1

project_name='lora_rlvr'
exp_name="dapo-qwen3-8b-sft-dolci-full_$(date +%m%d_%H%M)"
